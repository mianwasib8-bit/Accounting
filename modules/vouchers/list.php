...
<div class="card">
  <div class="table-wrap">
    <table class="data">
      ...
      <tbody>
      <?php if (!$rows): ?>
        <tr><td colspan="8" class="empty-state">No vouchers posted yet.</td></tr>
      <?php else: foreach ($rows as $r): ?>
        <tr>
          ...
          <td class="text-center" style="white-space:nowrap">
            <a href="view_voucher.php?id=<?= (int)$r['id'] ?>&type=<?= e($r['voucher_type']) ?>" class="icon-action" title="View">
              <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/>
              </svg>
            </a>
            <a href="print_voucher.php?id=<?= (int)$r['id'] ?>&type=<?= e($r['voucher_type']) ?>" class="icon-action" title="Print" target="_blank">
              <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/>
              </svg>
            </a>
            <a href="pdf_voucher.php?id=<?= (int)$r['id'] ?>&type=<?= e($r['voucher_type']) ?>" class="icon-action" title="PDF" target="_blank">
              <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
